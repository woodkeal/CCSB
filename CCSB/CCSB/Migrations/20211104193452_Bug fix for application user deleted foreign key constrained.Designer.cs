...
namespace CCSB.Migrations
{
    ...
    [Migration("20211104193452_Bug fix for application user deleted foreign key constrained")]
    partial class Bugfixforapplicationuserdeletedforeignkeyconstrained
    {
