        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicensePlate1 = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contracts", x => x.ContractId);
                    table.ForeignKey(
                        name: "FK_Contracts_Vehicles_LicensePlate1",
                        column: x => x.LicensePlate1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_LicensePlate1",
                table: "Contracts",
                column: "LicensePlate1");
